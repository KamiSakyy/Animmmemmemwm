...
Рабочая версия: **4.14.3** (`versionCode 59`), на основе проверенного `YORU-4.14.0-source-handoff.zip`.

- APK 4.14.3 публикуется после успешной проверки в `apk-output/`.
- [Серии, стабильный интерфейс и изображения без записи на диск](docs/YORU-4.14.3.ru.md)
