...
Рабочая версия: **4.14.1** (`versionCode 57`), на основе проверенного `YORU-4.14.0-source-handoff.zip`.

- [Изменения 4.14.1 и ограничения проверки](docs/YORU-4.14.1.ru.md)
