# YORU — состояние проекта после исправления 4.5.1

Текущая задача: исправить ошибку 4.5.0, где внутренние маршруты попали в список озвучек. В 4.5.1 маршруты не считаются голосами, а список озвучек строится по реальным названиям конкретной серии.
