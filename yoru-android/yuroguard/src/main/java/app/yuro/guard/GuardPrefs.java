...
public final class GuardPrefs {
    ...
    public static boolean dpiVpnBridge(Context c) { return sp(c).getBoolean("dpi_vpn_bridge", false); }
    public static void dpiVpnBridge(Context c, boolean v) { sp(c).edit().putBoolean("dpi_vpn_bridge", v).apply(); }
