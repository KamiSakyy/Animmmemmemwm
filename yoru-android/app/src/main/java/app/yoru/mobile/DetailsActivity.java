...
public final class DetailsActivity extends Activity {
    ...
    private void chooseWatchVoice(double number,String playMode){
        ...
        Ui.Progress wait=Ui.progress(this,"Загружаем озвучки серии "+Ui.number(number)+"…",true,this::cancelWatchPreparation);watchProgress=wait;
