...
public final class ImageLoader {
    ...
    private static String refererFor(String url){String host=host(url);if(host.contains("cdnlibs.org"))return "https://anilib.me/";if(host.contains("studiomir.club"))return "https://studiomir.club/";if(host.contains("astar.bz")||host.contains("an-media.org"))return "https://v30.astar.bz/";if(host.contains("shikimori"))return "https://shikimori.one/";return originFor(url)+"/";}
