...
public final class ImageLoader {
    ...
    private final Context context;private final ExecutorService pool=Executors.newFixedThreadPool(6,r->{Thread t=new Thread(r,"yoru-image");t.setPriority(Thread.NORM_PRIORITY-1);return t;});private volatile int generation;
    ...
    public void load(ImageView view,Anime a){loadInternal(view,a.poster,a.key(),assetFor(a));}
