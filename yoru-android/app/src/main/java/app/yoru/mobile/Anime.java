...
public final class Anime {
    public String source="shikimori", id="", title="", original="", alias="", poster="", description="", type="Аниме", status="", age="", studio="", trailerUrl="", airedDate="";
    ...
    public static final class Episode {
        public String id="", name="", lazy="", resolverUrl="", poster="";public double number;public int duration,openingStart,openingEnd;public final TreeMap<Integer,String> streams=new TreeMap<>();public final ArrayList<Variant> variants=new ArrayList<>();
