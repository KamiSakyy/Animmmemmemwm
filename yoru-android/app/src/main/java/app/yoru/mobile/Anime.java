...
public final class Anime {
    ...
    public final LinkedHashMap<String,String> shikimoriGenreIds=new LinkedHashMap<>();
    ...
    public static final class Episode {
        final java.util.concurrent.locks.ReentrantLock preparation=new java.util.concurrent.locks.ReentrantLock();
