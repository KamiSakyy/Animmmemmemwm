...
public final class Anime {
    public String source="shikimori", id="", title="", original="", alias="", poster="", description="", type="Аниме", status="", age="", studio="", trailerUrl="", airedDate="", nextEpisodeAt="";
    public int year, episodes, episodesAired, malId, anilistId, kpId;
    ...
    public String episodesLine(){int aired=aired();if(episodes>0&&aired>0&&aired<episodes)return "Вышло "+aired+" из "+episodes; if(episodes>0&&aired>=episodes)return "Вышло "+episodes+" из "+episodes; if(episodes>0)return episodes+" серий"; if(aired>0)return "Вышло "+aired; return "";}
