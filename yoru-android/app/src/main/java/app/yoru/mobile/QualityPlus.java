...
final class QualityPlus {
    ...
    static final String[] LABELS={"360p","480p","720p","1080p","1440p Quality+","2160p Quality+"};
    static final String[] LABELS_WITH_BEST={"360p","480p","720p","1080p","1440p Quality+","2160p Quality+","Лучшее доступное"};
    private QualityPlus(){}
    ...
    static String name(int value){int q=clamp(value);if(q<=360)return "360p";if(q<=480)return "480p";if(q<=720)return "720p";if(q<=1080)return "1080p";if(q<=1440)return "1440p Quality+";return "2160p Quality+";}
