    ...
    static Info probeInfo(String raw){
        ...
        for(int attempt=0;attempt<2;attempt++){
            ...
            try{
                ...
                String finalUrl=connection.getURL().toString();if(manifest(finalUrl))return new Info(-1,finalUrl.toLowerCase(Locale.ROOT).contains(".mpd")?"application/dash+xml":"application/x-mpegURL");String encoding=connection.getContentEncoding();
