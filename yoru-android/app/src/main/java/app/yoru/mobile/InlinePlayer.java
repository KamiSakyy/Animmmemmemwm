...
final class InlinePlayer extends LinearLayout {
    ...
    void restoreState(android.os.Bundle state){
        ...
        if(QualityPlus.validSelection(restoredQuality))requestedQuality=restoredQuality;
