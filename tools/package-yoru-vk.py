...
OUTPUT=ROOT/'handoff/YORU-VK-0.1.0-source.zip'
...
files += [ROOT/'.github/workflows/build-yoru-vk.yml',Path(__file__)]
for name in ['handoff/YORU-VK-0.1.0-BUILD.ru.md','handoff/YORU-VK-0.1.0-build.json']:
    path=ROOT/name
