...
YORU 2.5.0 добавляет встроенный VPN экран, импорт подписок, выбор локаций, режим `только YORU / выбранные приложения / все приложения`, `VpnService` и Xray-core integration point.
