...
final class Ui {
    ...
    static String error(Exception e){if(e instanceof Api.Failure||e instanceof IllegalArgumentException||e instanceof IllegalStateException)return e.getMessage();if(e instanceof java.net.SocketTimeoutException)return "Сервис не ответил вовремя. Повторите запрос.";return "Не удалось получить данные. Проверьте сеть, доступность сервиса и повторите. Токен в сообщения об ошибке не включается.";}
